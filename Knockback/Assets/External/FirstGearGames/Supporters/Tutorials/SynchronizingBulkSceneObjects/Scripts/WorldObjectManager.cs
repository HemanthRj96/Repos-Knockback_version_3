...
namespace FirstGearGames.Mirrors.SynchronizingBulkSceneObjects
{
    ...
    public class WorldObjectManager : NetworkBehaviour
    {
        ...
        public class AddedWorldObjectData
        {
            ...
            public AddedWorldObjectData(Vector3 position, Quaternion rotation, WorldObjectData data)
            {
                Position = position;
                Rotation = rotation;
                Data = data;
        ...
        {
            base.OnStartServer();
            BulkObjectsNetworkManager.RelayOnServerAddPlayer += BulkObjectsNetworkManager_RelayOnServerAddPlayer;
        }
        ...
        private void BulkObjectsNetworkManager_RelayOnServerAddPlayer(NetworkConnection obj)
        {
            ...
            foreach (WorldObject wo in _dirty)
            {
                ...
                if (wo.ReturnData().Instantiated)
                    addedWorldObjects.Add(new AddedWorldObjectData(wo.transform.position, wo.transform.rotation, wo.ReturnData()));
